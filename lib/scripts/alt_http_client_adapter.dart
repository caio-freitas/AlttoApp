...
typedef OnHttpClientCreate = dynamic Function(AltHttpClient client);

HttpClientAdapter createAdapter() => AltDefaultHttpClientAdapter();

/// The default HttpClientAdapter for Dio.
class AltDefaultHttpClientAdapter implements HttpClientAdapter {
  /// [Dio] will create HttpClient when it is needed.
  /// If [onHttpClientCreate] is provided, [Dio] will call
  /// it when a HttpClient created.
  OnHttpClientCreate onHttpClientCreate;

  AltHttpClient _defaultHttpClient;
  ...
  AltHttpClient _configHttpClient(Future cancelFuture, int connectionTimeout) {
